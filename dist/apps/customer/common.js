(self["webpackChunkcustomer"] = self["webpackChunkcustomer"] || []).push([["common"],{
...
/* harmony export */ });
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./entry */ 9638);
...
const remoteRoutes = [{
  ...
  path: 'list',
  loadComponent: () => __webpack_require__.e(/*! import() */ "apps_customer_src_app_remote-entry_customer-list_page_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./customer-list.page */ 7104)).then(m => m.CustomerListPage)
}, {
  path: 'create',
  loadComponent: () => __webpack_require__.e(/*! import() */ "apps_customer_src_app_remote-entry_customer-create_page_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./customer-create.page */ 7100)).then(m => m.CustomerCreatePage)
}, {
  path: 'details/:id',
  loadComponent: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./entry */ 9638)).then(m => m.RemoteEntry)
}];
...
/***/ 9638
/*!*****************************************************!*\
  !*** ./apps/customer/src/app/remote-entry/entry.ts ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class RemoteEntry {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 0,
      consts: [[1, "container-fluid", "px-0"], [1, "card", "border-0", "shadow-sm", "rounded-4", "mb-4"], [1, "card-body", "p-4"], [1, "badge", "text-bg-primary", "rounded-pill", "mb-2"], [1, "h3", "fw-bold"], [1, "text-body-secondary", "mb-0"], [1, "nav", "nav-tabs", "mb-4"], [1, "nav-item"], [1, "row", "g-3"], [1, "col-12", "col-md-6", "col-xl-3"], [1, "nav-link", 3, "routerLink"], [1, "card", "border-0", "shadow-sm", "rounded-4", "h-100", "text-decoration-none", 3, "routerLink"], [1, "fs-3", "text-primary"], [1, "h5", "mt-3", "text-body"]],
      template: function RemoteEntry_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](4, "Customer Remote");
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](5, "h1", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](6, "Customer Management 456");
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](7, "p", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](8, " Manage enterprise customers, accounts, contacts, and onboarding workflows. ");
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()();
