...
var moduleMap = {
	"./Routes": () => {
		return Promise.all(/*! __federation_expose_Routes */[__webpack_require__.e("default-webpack_sharing_consume_default_angular_core_angular_core"), __webpack_require__.e("default-webpack_sharing_consume_default_angular_router_angular_router"), __webpack_require__.e("common")]).then(() => (() => ((__webpack_require__(/*! apps/customer/src/app/remote-entry/entry.routes.ts */ 8992)))));
	}
};
...
/******/ 			chunkMatcher: function(chunkId) {return !/^default\-webpack_sharing_consume_default_angular_(co(mmon_angular_common|re_angular_core)|(platform\-browser_angular_platform\-brows|router_angular_rout)er)$/.test(chunkId)},
/******/ 			rootOutputDir: "",
...
/******/ var __webpack_exports__ = __webpack_require__(8318);
